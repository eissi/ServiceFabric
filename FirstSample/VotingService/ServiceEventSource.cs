...
{
    [EventSource(Name = "MyCompany-VoteSample-VotingService")]
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        [Event(ServiceRequestStartEventId, Level = EventLevel.Informational, 
            Message = "Service request '{0}' started. ActivityId: {1}.", Keywords = Keywords.Requests)]
        ...
        [Event(ServiceRequestStopEventId, Level = EventLevel.Informational, 
            Message = "Service request '{0}' finished. ActivityId: {1}.", Keywords = Keywords.Requests)]
